    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-4 lg:p-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-lg text-slate-400 leading-relaxed max-w-2xl">
          Visual identity and brand assets for coherosphere.
        </p>
      </div>
        ...
        <div className="lg:col-span-1 space-y-8">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 items-stretch">
              {[
                { title: "Decentralized", iconName: "Share2" },
                { title: "Intelligent", iconName: "Lightbulb" },
                { title: "Resilient", iconName: "Shield" },
                { title: "Collective", iconName: "Users" },
                { title: "Trustless", iconName: "Eye" },
                { title: "Solid", iconName: "Target" },
                { title: "Progressive", iconName: "Zap" },
                { title: "Inviting", iconName: "Heart" }
              ].map((value, index) => (
                <Card key={index} className="bg-slate-800/40 backdrop-blur-sm border-slate-700 hover:border-orange-500/50 transition-all duration-300">
                  <CardContent className="p-4 text-center">
                    <ConfiguredIcon 
                      ...
                      iconConfig={iconConfigs[value.iconName]}
                      size="w-7 h-7"
