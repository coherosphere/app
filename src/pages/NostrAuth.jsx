                ...
                <Card className="bg-slate-800/90 backdrop-blur-sm border-slate-700">
                    <CardHeader className="text-center">
                        <div className="flex justify-center mb-4">
                            <div className="w-16 h-16 bg-gradient-to-r from-orange-500 to-orange-600 rounded-full flex items-center justify-center resonance-glow">
                                <ConfiguredIcon 
                                  iconName="Globe" 
                    ...
                    {/* All previous content (the three cards) now goes into the CardContent of this main Card. */}
                    <CardContent className="space-y-6"> {/* Added CardContent for the main Card */}
                        ...
                        <Card className="bg-slate-800/50 backdrop-blur-sm border-slate-700">
                            ...
                            <CardContent className="space-y-6">
                                <div className="space-y-4">
                                    {[
                                        { id: 'initial', label: 'Start Authentication', iconName: 'Key' },
                                        { id: 'requesting_challenge', label: 'Request Challenge from Backend', iconName: 'Loader2' },
                                        { id: 'signing', label: 'Sign Challenge', iconName: 'Shield' },
                                        { id: 'verifying', label: 'Verify Signature on Backend', iconName: 'Loader2' },
                                        { id: 'success', label: 'Authentication Complete', iconName: 'CheckCircle' }
                                    ].map((flowStep, index) => {
                                        ...
                                        return (
                                            <div key={flowStep.id} className="flex items-center gap-4">
                                                <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                                                    ...
                                                    {isActive && flowStep.iconName === 'Loader2' ? (
                                                        <ConfiguredIcon 
                                                            iconName="Loader2" 
                                                        ...
                                                        <ConfiguredIcon 
                                                            iconName={flowStep.iconName} 
                                                            iconConfig={iconConfigs[flowStep.iconName]}
                                                            size="w-5 h-5"
                                                            fallbackColor="currentColor"
                                                        />
                                                    )}
