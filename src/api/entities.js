...
export const IconConfiguration = base44.entities.IconConfiguration;

export const PageInfo = base44.entities.PageInfo;

export const PerformanceMetricSnapshot = base44.entities.PerformanceMetricSnapshot;

export const SystemHealthCheckResult = base44.entities.SystemHealthCheckResult;

export const StatConfiguration = base44.entities.StatConfiguration;
