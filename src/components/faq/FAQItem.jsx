...
export default function FAQItem({ faq, isActive, onToggle, onLinkClick, iconConfigs }) {
  return (
      ...
      <h3 className="text-lg font-semibold text-white">
        ...
        >
          <span className="flex items-center gap-4">
            {faq.icon && (
              <ConfiguredIcon 
                iconName={faq.icon.charAt(0).toUpperCase() + faq.icon.slice(1)}
                iconConfig={iconConfigs?.[faq.icon.charAt(0).toUpperCase() + faq.icon.slice(1)]}
                size="w-5 h-5"
