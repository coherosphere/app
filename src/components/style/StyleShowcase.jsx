      ...
      <ShowcaseSection title="Cards & Data Display">
        <ShowcaseExample title="Stat Cards">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <StatCard iconName="Users" iconConfig={iconConfigs.Users} value="1,234" label="Active Members" isLoading={false} />
              <StatCard iconName="Wallet" iconConfig={iconConfigs.Wallet} value="4.5M" label="Sats Raised" isLoading={false} />
              <StatCard iconName="Lightbulb" iconConfig={iconConfigs.Lightbulb} value="42" label="Active Projects" isLoading={false} />
              <StatCard iconName="Globe" iconConfig={iconConfigs.Globe} value="8" label="Global Hubs" isLoading={false} />
            </div>
        </ShowcaseExample>

        <ShowcaseExample title="Loading States">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <StatCard iconName="Users" iconConfig={iconConfigs.Users} value="—" label="Loading..." isLoading={true} />
              <StatCard iconName="Wallet" iconConfig={iconConfigs.Wallet} value="—" label="Loading..." isLoading={true} />
            </div>
        </ShowcaseExample>
