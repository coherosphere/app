...
function ResonanceSortDropdown({ sortBy, onSortChange }) {
  ...
  const sortOptions = [
    { key: 'newest', label: 'Newest First', iconName: 'Clock' },
    { key: 'most-supported', label: 'Most Supported', iconName: 'Users' },
    { key: 'highest-resonance', label: 'Highest Resonance', iconName: 'Waves' },
    { key: 'most-funded', label: 'Most Funded', iconName: 'Bitcoin' },
  ];
    ...
    <div className="relative">
      ...
      >
        <div className="flex items-center gap-2">
          <ConfiguredIcon 
            iconName={currentSort.iconName}
            iconConfig={iconConfigs[currentSort.iconName]}
            size="w-4 h-4"
