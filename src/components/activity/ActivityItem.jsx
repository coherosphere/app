...
export default function ActivityItem({ activity, index, iconConfigs }) {
  ...
  const iconColor = activity.type === 'zap-in' ? 'text-yellow-400' : activity.type === 'zap-out' ? 'text-orange-400' : '';
            ...
            {(activity.type === 'zap-in' || activity.type === 'zap-out' || activity.type === 'zap-request') && activity.amount > 0 && (
              <div className="flex items-center gap-2 mt-3">
                <ConfiguredIcon 
                  ...
                  size="w-4 h-4"
                  fallbackColor={activity.direction === 'in' ? 'text-yellow-400' : 'text-orange-400'}
                />
