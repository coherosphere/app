...
import { MapPin, ChevronDown, Globe2, Lightbulb } from 'lucide-react'; // These imports will become unused but are part of the original, so they will be kept.
...
function HubSelectorDropdown({ hubs, selectedHubId, onHubChange }) {
  ...
  const { iconConfigs } = useAllIconConfigs(); // Added
    ...
    <div className="relative">
      ...
      >
        <div className="flex items-center gap-2">
          {/* Replaced MapPin with ConfiguredIcon */}
          <ConfiguredIcon 
            iconName="MapPin"
        ...
        >
          {/* Replaced ChevronDown with ConfiguredIcon */}
          <ConfiguredIcon 
      ...
      <CardHeader>
        <CardTitle className="text-white flex items-center gap-3">
          ...
          <ConfiguredIcon 
            ...
            iconConfig={iconConfigs['MapPin']}
            size="w-5 h-5"
            fallbackColor="text-turquoise-400"
          />
        ...
        <div className="text-sm text-slate-400 leading-relaxed mt-2 space-y-2">
          <p>
            ...
            >
              other hubs
              {/* Replaced Globe2 with ConfiguredIcon */}
              <ConfiguredIcon 
                iconName="Globe2"
            ...
            >
              projects
              {/* Replaced Lightbulb with ConfiguredIcon */}
              <ConfiguredIcon 
                iconName="Lightbulb"
